...
import static com.app.domain.cars_management.model.CarComparator.byColor;
...
class SortByColorTest {
    ...
    void test1() {
        ...
        var carsSortedByMethod = carsService.sortBy(byColor);
        Assertions
                .assertThat(carsSortedByMethod)
    ...
    void test2() {
        ...
        var carsSortedByMethod = carsService.sortBy(byColor.reversed());
        Assertions
                .assertThat(carsSortedByMethod)
                .isEqualTo(carListExpected);
    }
    ...
    void test3() {
        Assertions
                .assertThat(carsService.sortBy(byColor))
                .hasSize(3);
    }
}
